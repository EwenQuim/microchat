...
export type getResponseError = (getResponse400 | getResponse500 | getResponseDefault) & {
  headers: Headers;
};
...
export const getGetQueryOptions = <TData = Awaited<ReturnType<typeof get>>, TError = HTTPError | void>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof get>>, TError, TData>>, fetch?: RequestInit}
) => {
